...
interface Patient {
  ...
  riwayat_penyakit_jantung?: string; // ✅ DITAMBAHKAN
...
export default function HealthCheckPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    riwayat_penyakit_jantung: '', // ✅ DIPERBAIKI dari riwayat_jantung
    riwayat_merokok: '',
    bmi: '',
    gula_darah: ''
  });
  ...
  const selectPatient = (patient: Patient) => {
    ...
    // ✅ PERBAIKAN: Ambil data langsung dari database tanpa fallback default
    const newFormData = {
      ...
      tekanan_diastol: '',
      klasifikasi_hipertensi: '',
      // Ambil langsung dari DB, jika null/undefined tetap kosong
    ...
    console.log('Patient data riwayat_penyakit_jantung:', patient.riwayat_penyakit_jantung);
    console.log('Patient data riwayat_merokok:', patient.riwayat_merokok);
  };
  ...
  const clearSelection = () => {
    ...
    setFormData({
      ...
      tekanan_diastol: '',
      klasifikasi_hipertensi: '',
      riwayat_penyakit_jantung: '', // ✅ DIPERBAIKI
      riwayat_merokok: '',
      bmi: '',
      gula_darah: ''
    });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // ✅ DIPERBAIKI: Gunakan field name yang konsisten
      const response = await fetch('https://tcnisaa-prediksi-dm-adaboost.hf.space/predict', {
        ...
        body: JSON.stringify({
          ...
          heart_disease: formData.riwayat_penyakit_jantung, // ✅ DIPERBAIKI
      ...
      // ✅ DIPERBAIKI: Simpan ke database dengan field yang benar
