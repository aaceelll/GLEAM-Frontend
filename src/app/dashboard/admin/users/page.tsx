    ...
    <div className="min-h-screen bg-white px-6 md:px-10 py-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                  {/* <div className="hidden sm:flex items-center gap-2 px-4 py-2 bg-white rounded-xl shadow-sm"> */}
                    ...
                    <span className="text-sm font-medium text-gray-700">{rows.length} User</span>
                  </div> */}
                  <button
                    onClick={() => setShowAdd(true)}
                    className="group bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white rounded-xl flex items-center gap-2 px-4 py-2.5 shadow-lg hover:shadow-xl hover:scale-105 transition-all font-semibold"
                  >
            ...
            <div className="px-6 py-4">
              <div className="relative">
                ...
                <Input
                  ...
                  className="w-full pl-11 pr-4 py-2 rounded-xl border-2 border-gray-200 focus:border-green-500 focus:ring-4 focus:ring-green-100 outline-none"
                />
              </div>
            </div>
                        ...
                        <td className="p-8 text-center text-gray-500" colSpan={6}>
                          {searchQuery ? (
                            ...
                            <div className="py-8">
                              ...
                              <p className="text-sm text-gray-500 mt-1">Klik tombol "Tambah User" untuk memulai</p>
                            </div>
                          )}
                        </td>
                      </tr>
              ...
              <div className="px-6 pb-4">
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4 bg-gradient-to-r from-gray-50 to-slate-50 border-2 border-gray-100 rounded-2xl p-4">
                  <p className="text-sm text-gray-600">
                    ...
                    dari <span className="font-medium text-gray-900">{filteredRows.length}</span> user
                  </p>
                  <div className="flex gap-2">
                    <Button
                      ...
                      className="border-gray-300 hover:bg-green-50 hover:border-green-300 disabled:opacity-50 rounded-xl"
                    >
                      Sebelumnya
                    </Button>
                    {Array.from({ length: Math.min(5, totalPages) }, (_, i) => {
                      ...
                      return (
                        <Button
                          ...
                          className={
                            currentPage === page
                              ? "bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 rounded-xl shadow-md"
                              : "border-gray-300 hover:bg-green-50 hover:border-green-300 rounded-xl"
                          }
                        >
                          {page}
                        </Button>
      ...
      <AlertDialog open={!!toDelete} onOpenChange={(o) => !o && setToDelete(null)}>
        <AlertDialogContent className="rounded-3xl">
          <AlertDialogHeader>
            <AlertDialogTitle className="text-xl font-bold">Hapus user?</AlertDialogTitle>
            <AlertDialogDescription className="text-gray-600">
              Tindakan ini tidak bisa dibatalkan. User <b className="text-gray-900">{toDelete?.nama}</b> akan dihapus
              permanen.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              ...
              className="bg-gradient-to-r from-red-600 to-pink-600 hover:from-red-700 hover:to-pink-700 rounded-xl shadow-md"
            >
              Hapus
            </AlertDialogAction>
          </AlertDialogFooter>
